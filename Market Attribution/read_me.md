...
### Presentation
The SQL queries, along with snapshots of the query results, can be found as attachments to this repository. Below is the static version of the presentation(Insertimagehere)
